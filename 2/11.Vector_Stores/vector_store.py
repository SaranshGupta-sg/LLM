...
updated_doc1 = Document(
    page_content=(
        ...
        "batting performances. He holds the record for the most runs in IPL "
        "history, including multiple centuries in a single season. Despite "
        "RCB not winning an IPL title under his captaincy, Kohli's passion "
        "and fitness set a benchmark for the league. His ability to chase "
        "targets and anchor innings has made him one of the most dependable "
